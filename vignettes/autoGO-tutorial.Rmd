...
knitr::include_graphics("img/results/H460.2D_vs_H460.3D.2p/filtered_DE_thFC0_thPval0.05/volcano.png")
knitr::include_graphics("img/results/H460.2D_vs_H460.3D.2p/filtered_DE_thFC1_thPval0.05/volcano.png")
...
knitr::include_graphics("img/results/H460.2D_vs_H460.3D.2p/filtered_DE_thFC0_thPval0.05/down_genes/enrichment_plots/barplotGO_GO_Molecular_Function_2021.png")
```
...
```{r, echo=FALSE, out.width = '98%',  eval=TRUE} 
knitr::include_graphics("img/results/H460.2D_vs_H460.3D.2p/filtered_DE_thFC0_thPval0.05/down_genes/enrichment_plots/lolliGO_GO_Molecular_Function_2021.png")
```
...
knitr::include_graphics("img/results/ComparisonHeatmap/down_genes_GO_Biological_Process_2021_min3.png")
```
