...
* *outfile* : Default "barplotGO.png". If from_autoGO is TRUE, it's ignored. The name of the file containing the plot.
...
* *outfile* : Default "lolliGO.png". If from_autoGO is TRUE, it's ignored. The name of the file containing the plot.
